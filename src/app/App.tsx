...
function ProductsPage({ navigate, initialCategory }: { navigate: (p: Page, category?: ProductCategory) => void; initialCategory?: ProductCategory }) {
  ...
  const allProducts: ProductInfo[] = [
    ...
    {
      img: imgTap1,
      name: "AUTOMATIC STRETCH WRAPPER",
      brand: "all",
      desc: "High-performance automatic stretch wrapping system for high-volume pallet wrapping operations.",
      features: ["Fully automated", "High-speed operation", "Consistent tension control"],
    },
    {
      img: imgTap2,
    ...
    {
      img: imgTap28,
      name: "PET STRAPPING TOOL",
      brand: "all",
      desc: "Manual PET strapping tool for efficient tensioning and sealing of PET straps.",
      features: ["Manual operation", "Easy tensioning", "Secure sealing"],
    },
    {
      img: imgTap29,
      name: "BATTERY STRAPPING TOOL",
      brand: "all",
      desc: "Battery-powered strapping tool for cordless operation and enhanced mobility.",
      features: ["Battery-powered", "Cordless operation", "Enhanced mobility"],
    },
    {
      img: imgTap30,
      name: "PNEUMATIC STEEL STRAPPER",
      brand: "all",
      desc: "Pneumatic steel strapping tool for heavy-duty industrial applications.",
      features: ["Pneumatic power", "Heavy-duty", "Industrial grade"],
    },
    {
      img: imgTap31,
      name: "MANUAL STRAPPING TOOL",
      brand: "all",
      desc: "Manual strapping tool for versatile strapping applications across various industries.",
      features: ["Manual operation", "Versatile use", "Cost-effective"],
    },
    {
      img: imgTap32,
      name: "PNEUMATIC NAILER",
      brand: "all",
      desc: "Pneumatic nailer for fast and efficient packaging nail applications.",
      features: ["Pneumatic power", "Fast operation", "Precision nailing"],
    },
    {
      img: imgTap33,
      name: "PNEUMATIC STAPLER",
      brand: "all",
      desc: "Pneumatic stapler for high-speed packaging stapling operations.",
      features: ["Pneumatic power", "High-speed", "Consistent stapling"],
    },
    {
      img: imgTap34,
      name: "PET STRAP ROLL",
      brand: "all",
      desc: "High-quality PET strap rolls for reliable and durable strapping solutions.",
      features: ["High quality", "Durable material", "Various sizes"],
    },
    {
      img: imgTap35,
      name: "STEEL STRAP ROLL",
      brand: "all",
      desc: "Premium steel strap rolls for heavy-duty industrial strapping applications.",
      features: ["Premium quality", "Heavy-duty", "High strength"],
    },
  ];
